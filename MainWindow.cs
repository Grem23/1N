...
namespace programmingWF
{
    public partial class MainWindow : Form
    {
        ...
        protected internal MainWindow()
        {
            ...
            LabelChange(labelBalanceCount, data.Balance + " грн.");
        }
        ...
        private void buttonCloseProcurement_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Недостатньо коштів для закриття угоди.", "Помилка", MessageBoxButtons.OK,
                    MessageBoxIcon.Exclamation);
            }
            /*Конфликт между существующим в инвентаре элементом*/
            catch (MissingPrimaryKeyException)
            {
                MessageBox.Show("Ім'я товару або артикул не збігається з уже існуючим товаром на складі.", "Помилка", MessageBoxButtons.OK,
                    MessageBoxIcon.Exclamation);
            }
        }
        /*Отменить*/
        ...
        private void buttonCloseSale_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("На складі недостатньо товару.", "Помилка", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
        /*Отменить*/
        ...
        private void Serialize()
        {
            ...
            using (var fs = saveFileDialog.OpenFile())
            {
                ...
                MessageBox.Show("Склад успішно збережено.", "Збереження складу", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private bool Deserialize()
        {
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    MessageBox.Show("Склад успішно завантажений.", "Завантаження складу", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    return true;
                }
                /*Если произошла ошибка во время десериализации*/
                catch (System.Runtime.Serialization.SerializationException)
                {
                    MessageBox.Show("Неправильний файл серіалізації");
                }
            }
        }
